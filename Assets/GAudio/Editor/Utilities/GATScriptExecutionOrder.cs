...
{
	const string 	GAT_MANAGER_PATH	= "Assets/GAudio/Scripts/StaticAndSingletons/GATManager.cs",
					GAT_PLAYER_PATH  	= "Assets/GAudio/Scripts/Mixing/GATPlayer.cs",
					GAT_BUFFER_PATH		= "Assets/GAudio/Scripts/IO/_Classes/GATAudioBuffer.cs";
